  ...
  return (
    <section className="experience" id="experience">
      <div className="container">
        <div className="section-head"><p className="section-kicker">02 / Experience</p><div><h2 className="section-title">Learning by building in the real world.</h2><p className="section-subtitle">Professional experience across backend development, AI, OCR, and audio processing.</p></div></div>
